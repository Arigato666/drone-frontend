...
def main():
    ...
    with open("route_1.txt", "w", encoding="utf-8") as f:
        for pt in polyline_points:
            f.write(pt + "\n")
    print("✅ 已保存轨迹坐标到：route_1.txt")
    ...
    with open("cesium_route_1.txt", "w", encoding="utf-8") as f:
        f.write(cesium_array_str)
    print("✅ 已保存Cesium格式坐标数组到：cesium_route_1.txt")
